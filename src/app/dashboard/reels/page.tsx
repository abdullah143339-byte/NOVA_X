...
export default function ReelsPage() {
  ...
  return (
    <div className="fixed inset-x-0 top-[calc(env(safe-area-inset-top)+3.5rem)] bottom-[calc(env(safe-area-inset-bottom)+4rem)] md:left-16 md:bottom-0 lg:inset-y-0 lg:left-64 z-40 bg-[#0B0D12] overflow-hidden">
